...
class ResultMax3DProView extends StatefulWidget {
  const ResultMax3DProView({Key? key}) : super(key: key);

  @override
  State<ResultMax3DProView> createState() => _ResultMax3DProViewState();
}

class _ResultMax3DProViewState extends State<ResultMax3DProView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Kết quả Max 3D Pro"),
        leading: IconButton(
